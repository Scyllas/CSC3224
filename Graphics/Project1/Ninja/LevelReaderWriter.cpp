...
bool LevelReaderWriter::saveAsText(const std::string& filePath, const PlayerChar& player, const std::vector<Box>& boxes, const std::vector<Light>& lights) {
	// Keep this updated with newest version
	return saveAsTextV0(filePath, player, boxes, lights);
}

bool LevelReaderWriter::saveAsTextV0(const std::string& filePath, const PlayerChar& player, const std::vector<Box>& boxes, const std::vector<Light>& lights) {
...
bool LevelReaderWriter::saveAsBinary(const std::string& filePath, const PlayerChar& player, const std::vector<Box>& boxes, const std::vector<Light>& lights) {
	puts("saveBinary not implemented.");
	return false;
}

bool LevelReaderWriter::loadAsText(const std::string& filePath, b2World* world, PlayerChar& player, std::vector<Box>& boxes, std::vector<Light>& lights) {
	// Open file and error check
...
bool LevelReaderWriter::loadAsBinary(const std::string& filePath, b2World* world, PlayerChar& player, std::vector<Box>& boxes, std::vector<Light>& lights) {
	puts("loadBinary not implemented.");
	return false;
}

bool LevelReaderWriter::loadAsTextV0(std::ifstream& file, b2World* world, PlayerChar& player, std::vector<Box>& boxes, std::vector<Light>& lights) {
	{ // Read player
		glm::vec2 pos;
		glm::vec2 ddims;
		glm::vec2 cdims;
